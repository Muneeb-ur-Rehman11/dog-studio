...
export default function App() {
    ...
    <>
      <main>
        ...
        <div className="images">
          <img id="bg-img1" src="/bg1.png" alt="imghere" />
          <img id="bg-img2" src="/bg2.png" alt="imghere" />
          <img id="bg-img3" src="/bg3.png" alt="imghere" />
          <img id="bg-img4" src="/bg4.png" alt="imghere" />
          <img id="bg-img5" src="/bg5.png" alt="imghere" />
          <img id="bg-img6" src="/bg6.png" alt="imghere" />
          <img id="bg-img7" src="/bg7.png" alt="imghere" />
        </div>
        ...
        <Canvas
              ...
              style={{
                ...
                left: 0,
                zIndex: 0,
            // backgroundImage:"url(/public/background-xl.png)",
        ...
        <section id="section-1">
          ...
          <div className="middle" >
            <div className="left" >
              <h1>We are<br /> Crafting<br /> Emotions<br /> in Motion</h1>
            </div>
            <div className="right" >
              <h5>Dogstudio is a multidisciplinary <br />
                creative studio at the intersection <br />
                of art, design and technology.</h5>
  ...
  <div data-img="bg-img1" className="title">
    <small>Silent Motion</small>
    <h1>Whispers in Stillness</h1>
  </div>

  <div data-img="bg-img2" className="title">
    <small>Neon Pulse</small>
    <h1>Dreams in Electric Light</h1>
  </div>

  <div data-img="bg-img3" className="title">
    <small>Midnight Drift</small>
    <h1>Blooming Through the Dark</h1>
  </div>

  <div data-img="bg-img4" className="title">
    <small>Crystal Flow</small>
    <h1>Waves of Shattered Light</h1>
  </div>

  <div data-img="bg-img5" className="title">
    <small>Velvet Air</small>
    <h1>Floating Through Soft Skies</h1>
  </div>

  <div data-img="bg-img6" className="title">
    <small>Golden Hour</small>
    <h1>Drowning in Dusk Glow</h1>
  </div>

  <div data-img="bg-img7" className="title">
    <small>Soft Chaos</small>
    <h1>Order Within Beautiful Disorder</h1>
  </div>
</div>
        ...
        <section id="section-3" class="section-three">

  <div class="content left">
    <h2>We're crafting emotional experiences that improve results</h2>
  </div>

  <div class="content right">
    <p>
      Dogstudio is a design & technology firm working globally from our offices
      based in Belgium and Chicago.
      <br /><br />
      We’re passionate about moving people and solving problems for the likes
      of Microsoft, The Museum of Science And Industry Of Chicago, The Kennedy
      Center of Washington, Dragone, Quanta Magazine, and many more.
    </p>

    <a href="#" class="cta">Discover our values</a>
  </div>
...
<footer class="site-footer">
  ...
  <div class="footer-inner">
    ...
    <div class="footer-left">
      <h2>Dogstudio</h2>
      <p>Design & Technology Studio crafting emotional digital experiences.</p>
    </div>
